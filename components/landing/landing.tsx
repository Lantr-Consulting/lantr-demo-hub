...
const COPY = {
  ...
  en: {
    ...
    projects: [
      {
        number: "01", name: "AI Stock Analyst", chineseName: "AI investment research assistant", href: "https://analyst.lantr.site/demo", domain: "analyst.lantr.site", shot: "/shots/analyst.jpg", alt: "Portfolio screen from the Builder project AI Stock Analyst", field: "Finance × artificial intelligence", question: "How can AI form evidence-backed investment judgments within clear risk controls and human accountability?", summary: "The Builder created an end-to-end system connecting live market research, investor preferences, risk review, and simulated execution. Every proposal carries evidence, passes coded rules, and leaves the final decision with the user.", bullets: ["Translate natural-language preferences into explicit risk limits", "Use live market data to form evidence-backed research", "Check every paper order in code and require user approval"], note: "Simulated funds only, with no real trading", tint: "#e7eef0",
      },
      {
        number: "02", name: "AirAware", chineseName: "Environmental health planner", href: "https://airaware.lantr.site/demo", domain: "airaware.lantr.site", shot: "/shots/airaware.jpg", alt: "Today screen from the Builder project AirAware", field: "Environmental health × data", question: "How can fragmented environmental data become trustworthy personal guidance?", summary: "The Builder brought UV, heat, air quality, and pollen forecasts into one personal schedule. The system evaluates each outdoor window and recalculates its guidance as conditions change.", bullets: ["Integrate public weather, air-quality, and pollen data", "Translate public-health standards into testable rules", "Generate a personal plan and update it as forecasts change"], note: "General environmental-health information, not medical advice", tint: "#e8f0f2",
      },
      {
        number: "03", name: "PostPilot", chineseName: "Creator content workspace", href: "https://postpilot.lantr.site/demo", domain: "postpilot.lantr.site", shot: "/shots/postpilot.jpg", alt: "Content workspace from the Builder project PostPilot", field: "Content creation × artificial intelligence", question: "How can AI increase creative output while preserving sources, quality, and publishing responsibility?", summary: "The Builder designed an editorial system grounded in the creator’s original material. It organizes interviews, notes, and past work before generating ideas and drafts, while preserving source visibility and human review.", bullets: ["Organize interviews, notes, and past work into traceable sources", "Create channel-specific drafts and apply editorial checks", "Keep every draft under user review and export control"], note: "Users review every draft; the product never auto-publishes", tint: "#ecebea",
      },
    ],
  },
} as const;
