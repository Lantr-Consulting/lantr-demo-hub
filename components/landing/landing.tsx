...
const COPY = {
  ...
  en: {
    ...
    h1: "Let the work\nspeak for itself.",
    heroBody: "These aren't class projects. They're live products, designed, built, and shipped by Lantr Builders to the standard our own engineers work by. Open one and see what a student can build when the bar is professional.",
    ...
    bridgeBig: "Anyone can claim potential. Our Builders ship products.",
    bridgeSmall: "Finance, environmental health, content creation: three fields, three Builders. Each one turned what they know into a product you can open right now.",
    projectsEyebrow: "Selected Builder work / 01–03",
    ...
    processTitle: "Great products don't happen by accident.",
    processLead: "Every Builder owns their product end to end. Mentors push back the way senior engineers do in review. Nothing ships until it works, holds up under hard questions, and has been sharpened by feedback from people who used it.",
    phases: [
      ...
      ["02", "Build the foundation", "Core workflow, data model, AI capability. Get a usable version in front of people early."],
    ...
    accountTitle: "They built it. You try it.",
    accountLead: "No sign-up. No shared logins. Every demo runs in its own environment with isolated sample data, and anything consequential, from trades to posts to notifications, is simulated.",
    accountNote: "Demos run on simulated or public data and clear temporary records automatically.",
    finalTitle: "Three products so far. Yours could be next.",
    finalBody: "Lantr pairs ambitious students with professional engineers and a standard that doesn't bend. If you're ready to build something worth shipping, start here.",
