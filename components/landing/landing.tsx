...
const COPY = {
  ...
  en: {
    ...
    accountLead: "Each project runs in its own demo environment, with no sign-up and no shared logins. Sample data stays isolated, and anything consequential, from trades to posts to notifications, is simulated.",
    ...
    finalBody: "See how Lantr pairs the next generation with professional engineering practice, turning what they know and wonder about into products that ship.",
