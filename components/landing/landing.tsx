...
const COPY = {
  ...
  en: {
    ...
    h1: "Let the work\nspeak for itself.",
    heroBody: "Each of these products started as a problem a Builder cared about. They designed it, built it, tested it, and shipped it — held to the same standard as our own engineering work. Use them, see how they behave, and follow any decision that matters back to its reasoning.",
    heroPrimary: "Explore the products",
    heroSecondary: "See the Builder standard",
    ...
    bridgeSmall: "Finance, environmental health, and content creation demand different kinds of expertise. In each field, a Builder turned what they knew into a product people can use, question, and improve.",
    projectsEyebrow: "Selected Builder work / 01—03",
    projectsTitle: "Three live products. Three distinct ways to build with AI.",
    projectsLead: "Every project opens into its own interactive demo. Step inside, try the features, and see how each Builder handled data, safeguards, and the user’s final say.",
    ...
    processTitle: "From a problem worth solving to a product that holds up.",
    processLead: "Builders own every key decision. Mentors push back the way senior engineers do in review — on architecture, on tradeoffs, on evidence. Nothing ships until it works, survives hard questions, and has been improved by the people who use it.",
    phases: [
      ["01", "Choose a problem worth solving", "Start where the Builder’s curiosity already lives. Define who the product is for, when they’ll reach for it, and what a good outcome looks like."],
      ...
      ["03", "Improve through evidence", "Watch how people use it, verify what the model produces, and build sources, limits, and human approval into the product itself."],
      ["04", "Ship it and stand behind it", "Polish reliability and experience until the Builder can walk anyone through the architecture, the tradeoffs, and every decision that shaped the product."],
    ],
    processLink: "Explore the full Builder program",
    accountEyebrow: "Live demos",
    accountTitle: "Try the products for yourself.",
    accountLead: "Each project runs in its own demo environment — no sign-up, no shared logins. Sample data stays isolated, and anything consequential, from trades to posts to notifications, is simulated.",
    accountNote: "Demos run on simulated or public data and clear temporary records automatically.",
    finalTitle: "The next product on this page hasn’t been built yet.",
    finalBody: "See how Lantr pairs the next generation with professional engineering practice — turning what they know, and what they wonder about, into products that ship.",
    ...
    projects: [
      {
        number: "01", name: "AI Stock Analyst", chineseName: "AI investment research assistant", href: "https://analyst.lantr.site/demo", domain: "analyst.lantr.site", shot: "/shots/analyst.jpg", alt: "Portfolio screen from the Builder project AI Stock Analyst", field: "Finance × artificial intelligence", question: "How do you get AI to argue an investment case with evidence — and still leave the final call to a human?", summary: "AI Stock Analyst runs the full loop: live market research, a profile of the investor’s preferences, an automated risk review, and simulated execution. Every recommendation cites its data, passes coded risk checks, and waits for the user’s approval.", bullets: ["Turns plain-English preferences into explicit, enforceable risk limits", "Grounds its research in live market data, with sources attached", "Screens every paper trade against its risk rules, then asks the user to confirm"], note: "Paper trading only — no real money is involved", tint: "#e7eef0",
      },
      {
        number: "02", name: "AirAware", chineseName: "Environmental health planner", href: "https://airaware.lantr.site/demo", domain: "airaware.lantr.site", shot: "/shots/airaware.jpg", alt: "Today screen from the Builder project AirAware", field: "Environmental health × data", question: "How do you turn four scattered forecasts into one clear answer about your day outside?", summary: "AirAware folds UV, heat, air-quality, and pollen forecasts into one personal schedule. It scores each window of outdoor time and quietly re-plans the day when conditions shift.", bullets: ["Draws on public weather, air-quality, and pollen data", "Encodes public-health guidance as rules the system can test", "Plans around your schedule and updates as forecasts change"], note: "General environmental guidance, not medical advice", tint: "#e8f0f2",
      },
      {
        number: "03", name: "PostPilot", chineseName: "Creator content workspace", href: "https://postpilot.lantr.site/demo", domain: "postpilot.lantr.site", shot: "/shots/postpilot.jpg", alt: "Content workspace from the Builder project PostPilot", field: "Content creation × artificial intelligence", question: "Can AI speed up a creator’s output without flattening their voice — or their standards?", summary: "PostPilot starts from the creator’s own material — interviews, notes, past work — and organizes it before generating a single draft. Ideas stay traceable to their sources, and nothing leaves the workspace without the creator’s sign-off.", bullets: ["Organizes interviews, notes, and past work into a searchable source library", "Drafts for each platform and applies the creator’s editorial rules", "Leaves review, approval, and publishing entirely in the creator’s hands"], note: "Every draft is user-reviewed; nothing publishes automatically", tint: "#ecebea",
      },
    ],
  },
} as const;
